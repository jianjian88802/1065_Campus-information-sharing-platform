    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="举报原因" prop="jubaoyuanyin">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jubaoyuanyin" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jubaoyuanyin" label="举报原因" prop="jubaoyuanyin">
                    <span v-html="ruleForm.jubaoyuanyin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jubaoyuanyin = this.ruleForm.jubaoyuanyin.replace(reg,'../../../springboot2mc6m/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
